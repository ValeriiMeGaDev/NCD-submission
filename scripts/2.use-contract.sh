...
near call $CONTRACT hashNameAndPushIntoBlockChain '{"value":"Brian"}' --accountId $CONTRACT
...
near call $CONTRACT getNameByHashInBlockChain '{"value":"64452582"}' --accountId $CONTRACT
